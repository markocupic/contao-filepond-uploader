 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_form_field']['image_config_legend'] = 'Einstellungen für Bildbreite- und höhe';
$GLOBALS['TL_LANG']['tl_form_field']['filesize_legend'] = 'Einstellungen für zulässige Dateigrösse';
$GLOBALS['TL_LANG']['tl_form_field']['image_resize_legend'] = 'Einstellungen für die Verkleinerung der Bildauflösung während des Uploads';
...
$GLOBALS['TL_LANG']['tl_form_field']['minImageWidth'] = [
    'Minimale Bildbreite',
    'Hier können Sie die minimale Breite für Bild-Uploads in Pixeln festlegen.',
];
$GLOBALS['TL_LANG']['tl_form_field']['minImageHeight'] = [
    'Minimale Bildhöhe',
    'Hier können Sie die minimale Höhe für Bild-Uploads in Pixeln festlegen.',
];
$GLOBALS['TL_LANG']['tl_form_field']['imgResize'] = [
    'Bildgrößenänderung aktivieren',
    'Hier können Sie die Größenänderung des Bildes aktivieren.',
];
...
$GLOBALS['TL_LANG']['tl_form_field']['imgResizeBrowser'] = [
    'Browser-seitige Bildgrößenänderung aktivieren',
